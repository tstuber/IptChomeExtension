    ...
    var c = 0,
        ...
        r2 = function() {
            ...
            if (searchTerm) {
				...
				if(obj) {
					m.innerHTML = obj.name + ", " + obj.position;
					picture.innerHTML = "<img src='pics/" + obj.code.toLowerCase() + ".jpg' style='width:300px;height:225px;'>";
				} else {
		...
		lookup = function(searchTerm) {
			...
			{
			  if(employees[i].employee.code == searchTerm)
			  {
		...
		// Temporary employee list (json). 
		employees = [
			{"employee":   {"code":"TST", "name": "Thomas Stuber", "position": "Senior Consultant"}},
			{"employee":   {"code":"XBU", "name": "Xavier Butty", "position": "Love Consultant"}}
		]
